  ...
  return (
    ...
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      <header class="text-center">
        ...
        This season, we're all about bold colors, floral prints, and breezy silhouettes. Discover flowy dresses, statement jackets, and everything you need to create effortless, chic looks. Don't miss out on these limited-edition pieces and embrace the new season in style. Shop now!
        </p>
      </header>
  
      <ul class="mt-8 grid grid-cols-3 gap-4 lg:grid-cols-3">
        <li>
          <Link to={"/search/a"} class="group relative block">
            <img
        ...
        <li>
          <Link to={"/search/laptop"} class="group relative block">
            <img
